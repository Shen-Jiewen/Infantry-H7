...
typedef enum {
	REFEREE_DMA_MEMORY_0,
	REFEREE_DMA_MEMORY_1
} referee_dma_memory_e;
...
typedef struct __attribute__((packed))  //0101
{
	uint32_t event_type;
} ext_event_data_t;
...
extern void get_robot_power_limit(uint16_t *supercap_power_limit);

...
/**************************** 内容ID 数据 ********************/
#define UI_Data_ID_Del 0x100      // 删除操作
#define UI_Data_ID_Draw1 0x101    // 画一个图形
#define UI_Data_ID_Draw2 0x102    // 画两个图形
#define UI_Data_ID_Draw5 0x103    // 画五个图形
#define UI_Data_ID_Draw7 0x104    // 画七个图形
#define UI_Data_ID_DrawChar 0x110 // 画字符
